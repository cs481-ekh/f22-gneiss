...
class PacketRequestHandlerTests {
    ...
    fun getAllPacketsTest() {
        ...
        val expectedResponse = ResponseEntity<PacketGetAllResponse>(PacketGetAllResponse(mutableSetOf<String>("somePacketId1", "somePacketId2")), HttpStatus.OK)
    ...
    fun getAllPacketsNoAuthTest() {
        ...
        val expectedResponse = ResponseEntity<PacketGetAllResponse>(PacketGetAllResponse(emptySet()), HttpStatus.UNAUTHORIZED)
